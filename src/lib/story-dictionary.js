...
export const STORY_TERMS = {
  ...
  doubleChance: { term: 'Dos resultados combinados', hint: 'Probabilidad combinada de dos resultados (p. ej. local o empate), con fin descriptivo.' },
  dnb: { term: 'Resultado sin empate', hint: 'Quién tendría mayor probabilidad si se excluye el empate.' },
  overUnder: { term: 'Goles totales por umbrales', hint: 'Si el total supera o no los 1.5, 2.5 o 3.5 goles.' },
  btts: { term: 'Marcan los dos', hint: 'Si anotan ambos equipos o al menos uno se queda en cero.' },
  exactScore: { term: 'Marcadores más frecuentes', hint: 'Los resultados exactos que más se repiten en el cálculo.' },
  ...
  predicted: { term: 'Mayor probabilidad estimada', hint: 'A quién asigna mayor probabilidad el modelo externo (Bzzoiro).' },
  ...
  forecast: { term: 'Lo que estima el cálculo', hint: 'Valores esperados para cada cifra del partido, con la muestra declarada.' },
  ...
  verdict: { term: 'La síntesis', hint: 'La lectura combinada de GoatLab, con cada insumo y su peso a la vista.' },
};
